...
public class CodeGenerator {
    ...
    public void initCodeTool(List<Column> lsColumns) throws Exception {
        ...
        tool.put("domainPkg", (StringUtil.isEmpty(domainPkg) ? "" : ("." + domainPkg)));
        tool.put("daoPkg", (StringUtil.isEmpty(daoPkg) ? "" : ("." + daoPkg)));
        tool.put("daoSuffix", (StringUtil.isEmpty(daoSuffix) ? "" : daoSuffix));
